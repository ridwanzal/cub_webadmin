          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/buttons.html">Add User</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="pages/ui-features/typography.html">Remove User</a>
                </li>
              </ul>
            </div>
          </li>
          ...
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                ...
                <p>Welcome to CUB webadmin. Manage and view your CUB account.</p>
                ...
                <!-- <i class="mdi mdi-close popup-dismiss d-none d-md-block" style="float: right;"></i> -->
              </span>
            </div>
          </div>
          <div class="row">
