...
echo '
  <div class="wrapper">
    <div class="main_header_container">
      <a href="index.php" ><img src="views/img/logo.png" id="main-logo"></a>
      <a class="menu_list" title="Home" id="menu_list_home" href="index.php">Home</a>
      <a class="menu_list" title="Plans" id="menu_list_plans" href="plans.php">Plans</a>
